...
var DATA = {
    ...
    2025: {
      ...
      8: [
        { label: 'Whisper bretons', pro: false, emoji: '🌬️', details: { title: 'Whisper bretons', body: ['Entraînement de deux modèles Whisper en breton. L\'un produisant des transcriptions en breton à partir d\'audio en breton, l\'autre des transcriptions en français à partir d\'audio en breton.<br>Ces modèles n\'ont aucune prétention particulière et doivent être vus comme une expérience/une V0 pour établir une baseline.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/Bretagne/whisper-large-v3-turbo-audio_breton-transcription_breton' }] } }
      ],
      9: [
