...
var DATA = {
    2019: {
      ...
      11:[
        { label: 'Illustration du <i>bag-of-words</i>', emoji: '👜', pro: false, details: { title: 'Illustration du bag-of-words', body: ['Le <i>bag-of-words</i> est la technique qui était majoritairement utilisée avant l\'apparition des modèles basés sur les réseaux de neurones tels que les RNN (eux-mêmes moins utilisés aujourd\'hui au profit des transformers). C\'est avant tout un article servant à initier la série sur les articles de blog consacrés au NLP.'], links: [{ label: 'Lire l\'article', url: 'https://lbourdois.github.io/blog/nlp/Bag-of-word/' }] } },
        { label: 'Illustration du <i>word embedding</i>', emoji: '📏', pro: false, details: { title: 'Illustration du word embedding', body: ['Illustration du word embedding et d\'une de ses applications : le word2vec de Google. Permet de comprendre par la suite des concepts cruciaux en NLP comme l\'autosupervisé ou ce que sont les modèles d\'embedding énormément utilisés pour la recherche de documents / les moteurs de recherche. Il s\'agit d\'une traduction de l\'<a href="https://jalammar.github.io/illustrated-word2vec/">article de blog</a> de Jay ALLAMAR.'], links: [{ label: 'Lire l\'article', url: 'https://lbourdois.github.io/blog/nlp/word_embedding/' }] } }
      ],
      12:[
    ...
    2023: {
      ...
      10:[
        ...
        { label: 'frenchKEYWORDS', emoji: '🏷️', pro: true, details: { title: 'frenchKEYWORDS', body: ['Jeu de données d\'extraction de mots-clés en français regroupant 4 sources open-source (wikinews-fr-100, termith-eval, taln-archives, papyrus), nettoyées afin de supprimer les fuites et doublons. Au total 16 471 lignes : 12 002 en entraînement, 1 488 en validation et 2 981 en test. Ce travail a été développé au <a href="https://huggingface.co/CATIE-AQ">CATIE</a>.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/datasets/CATIE-AQ/frenchKEYWORDS' }] } }
      ],
      11:[
        { label: 'FrenchPARAPHRASE', emoji: '👥', pro: true, details: { title: 'FrenchPARAPHRASE', body: ['Jeu de données de paraphrase en français regroupant 7 sources open-source (tatoeba_mt, TaPaCo, PAWS-X, paraphrasing_french_5000, paraphrasing_french, paragraphss_paraphrasing, multi_paraphrasing_french), nettoyées afin de supprimer les fuites et doublons. Au total 254 513 lignes : 251 753 en entraînement, 1 857 en validation et 903 en test. Ce travail a été développé au <a href="https://huggingface.co/CATIE-AQ">CATIE</a>.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/collections/lbourdois/french-paraphrase-dataset' }] } },
        { label: 'Archive sonore en breton', emoji: '🗃️', pro: false, details: { title: 'Archive sonore en breton', body: ['J\'ai collecté un maximum d\'enregistrements en breton trouvés sur internet afin de constituer une archive (~14 000 heures d\'audio). L\'objectif étant de sauvegarder ces audios afin qu\'ils restent accessibles à long terme (les sites internet pouvant disparaître, phénomène très impactant pour une langue minoritaire). Certaines sources étant probablement sous droit d\'auteur, l\'archive est mise à disposition uniquement des chercheurs travaillant dans des instituts de recherche français (INRIA, CNRS, etc.) et des universités françaises.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/collections/Bretagne/br-archive-sonore-en-breton' }] } }
      ],12:[
        { label: 'Jeux de données audio pour le français', emoji: '👂', pro: false, details: { title: 'Jeux de données audio pour le français', body: ['Référencement de jeux de données en français pour pré-entraîner un modèle audio puis le fine-tuner sur une tâche particulière (transcription, classification, traduction, etc.). La collection complète (~117 000 heures d\'audio) a été ouverte publiquement en mai 2025. Certaines sources étant probablement sous droit d\'auteur, elle est mise à disposition uniquement des chercheurs travaillant dans des instituts de recherche français (INRIA, CNRS, etc.) et des universités françaises.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/collections/lbourdois/french-audio-datasets-pretraining' }] } },
        { label: 'CFP', emoji: '💬', pro: true, details: { title: 'Chat French Prompts (CFP)', body: ['Jeu de données de prompts en français natifs (non-traduits) regroupant 11 sources open-source, manuellement nettoyé. Au total 56 277 lignes couvrant de nombreuses tâches (question answering, génération de texte, classification, NER, etc.). Ce travail a été développé au <a href="https://huggingface.co/CATIE-AQ">CATIE</a>.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/datasets/CATIE-AQ/CFP' }] } },
    ...
    2024: {
      ...
      2:[
        ...
        { label: 'Toujours vérifier la qualité des datasets', emoji: '🔬', pro: false, details: { title: 'Toujours vérifier la qualité des jeux de données', body: ["Article analysant la qualité de 596 jeux de données disponibles sur le Hub d\'Hugging Face, en mesurant les fuites entre splits et les données dupliquées. Il ressort que plus de 60 % des échantillons de test analysés contiennent un biais (duplications ou fuites)."], links: [{ label: 'Lire l\'article', url: 'https://lbourdois.github.io/blog/LLE/' }] } },
        { label: 'FrenchSIMPLIFICATION', emoji: '👓', pro: true, details: { title: 'FrenchSIMPLIFICATION', body: ['Jeu de données de simplification de textes en français regroupant 4 sources open-source (CLEAR, Wikilarge, BiSECT, Alector), nettoyées afin de supprimer les fuites et doublons. Au total 785 625 lignes : 781 801 en entraînement, 2 385 en validation et 1 439 en test. Ce travail a été développé au <a href="https://huggingface.co/CATIE-AQ">CATIE</a>.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/datasets/CATIE-AQ/frenchSIMPLIFICATION' }] } }
      ],
      3:[],
      4:[
        ...
        { label: 'FrenchSUM longues séquences', emoji: '📚', pro: true, details: { title: 'FrenchSUM longues séquences', body: ['Jeux de données de résumé automatique et de textes longs en français. <a href="https://huggingface.co/datasets/CATIE-AQ/french_books_summaries">french_books_summaries</a> contient 949 livres français avec leurs résumés (1 513 lignes au total). Il est accompagné de <a href="https://huggingface.co/datasets/CATIE-AQ/french_books">french_books</a> contenant 2 075 livres français sans résumé, destinés au pré-entraînement. Ces deux jeux de données doivent permettre de travailler sur de très longues séquences (jusqu\'à 262K tokens). Ce travail a été développé au <a href="https://huggingface.co/CATIE-AQ">CATIE</a>.'], links: [{ label: 'french_books_summaries', url: 'https://huggingface.co/datasets/CATIE-AQ/french_books_summaries' }, { label: 'french_books', url: 'https://huggingface.co/datasets/CATIE-AQ/french_books' }] } },
        { label: 'Narrativeqa fr', emoji: '❓', pro: true, details: { title: 'Narrativeqa fr', body: ['Jeu de données de Question Answering en français sur de longs textes littéraires (romans). Il contient 143 livres en français natif avec leurs questions et réponses, traduites à partir du jeu de données narrativeqa. Au total 4 207 questions et 7 771 réponses : 3 070 en entraînement, 382 en validation et 753 en test. Ce travail a été développé au <a href="https://huggingface.co/CATIE-AQ">CATIE</a>.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/datasets/CATIE-AQ/french_narrativeqa' }] } }
      ],
      5:[],6:[],7:[],
      8:[
        { label: 'Les papiers de Merve', emoji: '📷', pro: false, details: { title: 'Les papiers de Merve', body: ['Space Hugging Face qui regroupe une trentaine de résumés de publications récentes en vision par ordinateur et VLM. Ils ont été rédigés par <a href="https://huggingface.co/merve">Merve NOYAN</a> et je les avais centralisés dans cette app lorsque je faisais à l\'époque de la veille sur le sujet.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/spaces/merve/vision_papers' }] } }
      ],
      9:[],
      10:[
        { label: 'Collection de données d\'ASR en breton', pro: false, emoji: '🗣️', details: { title: 'Collection de données d\'ASR en breton', body: ['Portage et nettoyage sur Hugging Face de jeux de données d\'audio en breton pour faciliter l\'entraînement de modèle d\'ASR dans cette langue.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/collections/Bretagne/br-audio-finetuning-asr-en-breton' }] } },
        { label: 'Collection de données de traduction breton/français', pro: false, emoji: '📚', details: { title: 'Collection de données de traduction breton/français', body: ['Portage et nettoyage sur Hugging Face de jeux de données de traduction breton/français pour faciliter l\'entraînement de tels modèles.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/collections/Bretagne/br-traduction-propre' }] } }
      ],
      11:[
    ...
    2025: {
      1: [{
        ...
        details: {
          ...
          body: [
            'Le FAT5 est une implémentation du <a href="https://arxiv.org/abs/1910.10683">T5</a> en PyTorch avec un objectif <a href="https://arxiv.org/abs/2205.05131">UL2</a> optimisé pour GPGPU, développé avec <a href="https://b-albar.github.io/portfolio/">Boris ALBAR</a> au <a href="https://huggingface.co/CATIE-AQ">CATIE</a> tout au long de l\'année 2024. Elle utilise des noyaux CUDA et Triton personnalisés ainsi que des optimisations spécifiques pour augmenter le débit et réduire l\'utilisation de la mémoire d\'un facteur 2 par rapport à l\'implémentation originale de Hugging Face. Nous l\'avons appliquée en pré-entraînant un modèle en français de 147M paramètres sur une seule A100, pour un coût estimé à 1 200 € (instance Sesterce).'
      ...
      3: [
        { label: 'French OCR datasets', emoji: '📝', pro: false, details: { title: 'French OCR datasets', body: ['Jeux de données d\'OCR en français (soit original, soit traduit depuis l\'anglais), destinés à l\'entraînement de VLM. Ces datasets s\'inscrivent dans le cadre du projet « La marmitte » dont le but est de proposer à terme un équivalent en français du jeu de données <a href="https://huggingface.co/datasets/HuggingFaceM4/the_cauldron"><em>the cauldron</em></a> des équipes d\'Hugging Face.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/collections/lbourdois/french-ocr-datasets' }] } },
      ...
      5: [
        ...
        { label: 'Breton packs', pro: false, emoji: '📚', details: { title: 'Breton packs', body: ['Actualisation des données précédemment créées pour le breton, portage de nouvelles sur Hugging Face (plus de 200 jeux de données au final), nettoyage et classement dans plusieurs collections de ces données.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/collections/lbourdois/breton-packs' }] } }
      ],
      6: [
        ...
        { label: 'NanoBEIR-fr', emoji: '🍺', pro: true, details: { title: 'NanoBEIR-fr', body: ['Traduction du benchmark NanoBEIR en français afin de pouvoir avoir un jeu de données d\'évaluation d\'IR en français. À noter qu\'il n\'a pas été nettoyé (pas de suppressions de fuites, données dupliquées, vides ou aberrantes) alors qu\'il contient des erreurs. Ce non-nettoyage a été décidé suite à une discussion avec Tom Aarsen afin que le jeu de données puisse être facilement utilisable avec la librairie Sentence Transformers (le nettoyage aurait cassé le pipeline de la librairie). Nous vous invitons donc à post-traiter vos résultats. Ce travail a été développé au <a href="https://huggingface.co/CATIE-AQ">CATIE</a>.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/collections/CATIE-AQ/nanobeir-fr' }] } },
        { label: 'XMrec datasets (partie en français)', pro: true, emoji: '🛒', details: { title: 'French XMrec', body: ['Portage sur Hugging Face de la partie en français du jeu de données XMrec, destiné à l\'évaluation des systèmes de recommandation multilingues. Ce travail a été développé au <a href="https://huggingface.co/CATIE-AQ">CATIE</a>.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/collections/CATIE-AQ/xmrec-french-part-reviews-and-metadata-datasets' }] } }
      ],
      7: [
        { label: 'Jeux de données de DPO et de conversations en français', emoji: '🤝', pro: false, details: { title: 'Jeux de données de DPO et de conversations en français', body: ['Jeux de données de préférences (DPO) et de conversations en français, destinés au finetuning de LLM.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/collections/lbourdois/french-dpo-and-conversation-datasets' }] } }
      ],
      8: [
        { label: 'Whisper bretons', pro: false, emoji: '🌬️', details: { title: 'Whisper bretons', body: ['Entraînement de deux modèles Whisper en breton. L\'<a href="https://huggingface.co/Bretagne/whisper-large-v3-turbo-audio_breton-transcription_breton">un</a> produisant des transcriptions en breton à partir d\'audio en breton, l\'<a href="https://huggingface.co/Bretagne/whisper-large-v3-turbo-audio_breton-transcription_francais">autre</a> des transcriptions en français à partir d\'audio en breton.<br>Ces modèles n\'ont aucune prétention particulière et doivent être vus comme une expérience/une V0 pour établir une baseline.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/Bretagne/models' }] } }
      ],
      9: [
...
724 prompts ont été écrits sous forme impérative, de tutoiement et de vouvoiement afin de couvrir autant que possible les données de pré-entraînement utilisées par le modèle qui utilisera ces données et qui nous sont inconnues.<br>
Les colonnes <em>inputs</em> et <em>targets</em> suivent le même format que l'ensemble de données <a href="https://huggingface.co/datasets/bigscience/xP3">xP3</a> de Muennighoff et al.<br>
...
Le contenu est structuré en 5 chapitres répartis sur 30 pages web 🌐 et 3 notebooks Jupyter 📓.<br>
