  ...
  "Article analysant la qualité de 596 jeux de données disponibles sur le Hub d\'Hugging Face, en mesurant les fuites entre splits et les données dupliquées. Il ressort que plus de 60 % des échantillons de test analysés contiennent un biais (duplications ou fuites)."
    ...
    2025: {
      ...
      10: [
        ...
        { label: 'Jeux de données de raisonnement et d\'appels d\'outils en français', emoji: '🛠️', pro: false, details: { title: 'Jeux de données de raisonnement et d\'appels d\'outils en français (soit original, soit traduit depuis l\'anglais) destinés à l\'entraînement de LLM.', body: ['Jeux de données de raisonnement et d\'appel d\'outils (tool calling) en français.'], links: [{ label: 'Hugging Face', url: 'https://huggingface.co/collections/lbourdois/french-think-and-toolcalling-datasets' }] } }
      ],
      11: [],
      12: []
    },
